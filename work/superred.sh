...
function sp11_compile_cmd(){
	...
	echo -e "拷贝文件："
	echo -e "scp yinaizhong@10.65.8.115:/data2/yinaizhong/sp11/ums9620-a11/out/target/product/ums9620_sp11/cp_sign/QOGIRN6PRO_SUPER_SIGN_R/ums9620_sp11_native-userdebug-native_QOGIRN6PRO_SUPER_SIGN_R.pac ."
        echo -e "启动刷机模式："
