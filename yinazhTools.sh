...
function helps(){
    ...
    echo -e "${FONT_YELLOW_UNDERLINE}开发帮助${FONT_RES}： adb_tools_help， keydown_help， broad_help， logcat_help， app_runtime_help， android_help， android_system_help， debug_help， git_help， doc_help， windows_help"
