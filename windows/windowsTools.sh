...
function windows_help(){
    echo -e "${FONT_RED_UNDERLINE}startScrcpy${FONT_RES}"
...
alias startScrcpy='start /d/tools/ShellTools/source/ignore/scrcpy-win64-v1.24/scrcpy.exe'
...
alias startDownload='start /c/Users/yinazh/Downloads'
